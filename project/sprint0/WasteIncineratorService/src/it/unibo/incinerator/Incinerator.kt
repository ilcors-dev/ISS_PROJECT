		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t014",targetState="startBurning",cond=whenDispatch("startIncinerator"))
				}	 
				state("startBurning") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t015",targetState="startBurning",cond=whenDispatch("startIncinerator"))
				}	 
			}
		}
} 
